" Original colorscheme for lightline.vim.
" Put this file in <~/.vim/autoload/lightline/colorscheme/>.
...
let g:lightline#colorscheme#mylightline#palette = lightline#colorscheme#fill(s:p)
